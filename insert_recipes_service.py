#!/usr/bin/env python3
"""
Insertar 200 recetas usando Service Role Key (bypass RLS)
"""
import requests
import json
import re

# Credenciales de Supabase - Service Role Key (bypass RLS)
SUPABASE_URL = "https://kaomgwojvnncidyezdzj.supabase.co"
SERVICE_KEY = "eyJhbGciOiJIUzI1NiIsInR5cCI6IkpXVCJ9.eyJpc3MiOiJzdXBhYmFzZSIsInJlZiI6Imthb21nd29qdm5uY2lkeWV6ZHpqIiwicm9sZSI6InNlcnZpY2Vfcm9sZSIsImlhdCI6MTc3MjcwNzE3NiwiZXhwIjoyMDg4MjgzMTc2fQ.7J5L5sOB9rJvHNDrGJ_vFH8B-2xPQJlQlXQy5gNF5cQ"
